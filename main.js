...
const makeCampaigns = (data, svg) => {
    ...
    makeCampaign(campaignData, svg)
}

const makeCampaign = (campaignData, svg) => {
    console.log(campaignData)
    const campaignId = campaignData.groups.Campaign.metadata.name
    ...
    makeLineChart(acqData, svg)
}

const makeLineChart = (d, svg) => {
    console.log(d)
